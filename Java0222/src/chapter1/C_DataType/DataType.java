...
public class DataType {
	...
	public static void main(String[] args) {
		...
		double resultA = integer + decimalA ;
		int resultB =  (int) (integer + decimalA) ; // 소수 + 정수에서 선언된 자료형이 정수 라서 강제 형변환.
		...
		// 참조형 데이터 타입
		// 기본 데이터 타입이 아닌 메모리 주소를 참조하는 데이터 타입 ex) String
		// 참조형 데이터 타입은 첫 문자가 대문자.
	}
